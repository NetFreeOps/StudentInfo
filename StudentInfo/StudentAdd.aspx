<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="StudentAdd.aspx.cs" Inherits="StudentInfo.StudentAdd" EnableEventValidation="false" %>
            ...
            <div class="widget-body am-fr">
                ...
                <div class="am-form-group">
                    <label for="user-name" class="am-u-sm-3 am-form-label">
                        学号</label>
                    <div class="am-u-sm-9">
                        <input type="text" class="tpl-form-input" id="id" placeholder="请输入学号" runat="server"/>
                    </div>
                </div>
                 <div class="am-form-group">
                    <label for="user-name" class="am-u-sm-3 am-form-label">
                 ...
                 <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <select data-am-selected="{searchBox: 1}" id="StudentClass" style="display: none;" runat="server">
                            <option value="计算机18-1">18-1</option>
                            <option value="计算机18-2">18-2</option>
                        </select>
                    </div>
                </div>
